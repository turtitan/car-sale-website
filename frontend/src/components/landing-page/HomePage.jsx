        ...
        <div className={layoutStyles.container}>
            ...
            >
                <div className={layoutStyles.sectionContainer}>
                    ...
                    <div className={featureCardStyles.grid}>
                        <div 
                            className={featureCardStyles.cardAnimated(animateFeatures, featureCardStyles.delays.first)}
                            style={colorStyles.backgroundLightGray}
                        >
                            <div 
                                className={featureCardStyles.iconContainerBlue}
                                style={colorStyles.backgroundLightGray}
                            >
                                <CheckCircle 
                                    className={iconStyles.mediumCheckCircle}
                                    style={colorStyles.primaryBlue}
                                />
                            </div>
                            <h3 
                        ...
                        <div 
                            className={featureCardStyles.cardAnimated(animateFeatures, featureCardStyles.delays.second)}
                            style={colorStyles.backgroundLightGray}
                        >
                            <div 
                                className={featureCardStyles.iconContainerGreen}
                                style={colorStyles.backgroundLightGray}
                            >
                                <Star 
                                    className={iconStyles.mediumStar}
                                    style={colorStyles.successGreen}
                                />
                            </div>
                            <h3 
                                className={typographyStyles.h3}
                        ...
                        <div 
                            className={featureCardStyles.cardAnimatedThird(animateFeatures)}
                            style={colorStyles.backgroundLightGray}
                        >
                            <div 
                                className={featureCardStyles.iconContainerPurple}
                                style={colorStyles.backgroundLightGray}
                            >
                                <Users 
                                    className={iconStyles.mediumUsers}
                                    style={colorStyles.accentPurple}
                                />
                            </div>
                            <h3 
                                className={typographyStyles.h3}
